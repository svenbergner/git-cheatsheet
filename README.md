...
## Contents
 ...
 - [Cleanup local repos](#cleanup-local-repos)
   ...
   - [Manually Delete local branches that have been removed from remote repo on fetch/pull](#manually-delete-local-branches-that-have-been-removed-from-remote-repo-on-fetchpull)
   - [Always delete local branches that have been removed from remote repo on fetch/pull](#always-delete-local-branches-that-have-been-removed-from-remote-repo-on-fetchpull)
